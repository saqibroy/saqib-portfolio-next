...
const capabilityGroups = [
  ...
  { title: 'Applied AI integration', description: 'AI requests kept behind explicit service boundaries and structured application state.', technologies: 'FastAPI · RAG · vector retrieval · LLM integration', links: [{ label: 'AI-assisted workflow', href: '/work/ai-assisted-contract-workflow' }, { label: 'Velsa role', href: '#velsa-technologies' }] },
