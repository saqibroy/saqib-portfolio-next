...
const projects: ProjectSummary[] = [
  {
    ...
    summary: 'A private, redacted contract workflow connecting a React/TypeScript editor, Django application backend, FastAPI AI service, and Stripe purchase flow.',
...
const capabilities: Capability[] = [
  ...
  },
  {
    ...
    description: 'LLM inference, vector retrieval, RAG, structured input, and predictable application integration.',
    evidenceIds: ['approved-velsa'],
    relatedProjectSlugs: ['ai-assisted-contract-workflow'],
    relatedRoleIds: ['velsa-technologies'],
  },
